"""idol_studio_17905 URL Configuration
...
admin.site.site_header = "Idol Studio"
admin.site.site_title = "Idol Studio Admin Portal"
admin.site.index_title = "Idol Studio Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Idol Studio API",
        default_version="v1",
        description="API documentation for Idol Studio App",
    ),
    public=True,
